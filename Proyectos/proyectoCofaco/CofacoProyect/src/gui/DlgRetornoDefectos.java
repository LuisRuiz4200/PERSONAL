...
public class DlgRetornoDefectos extends JInternalFrame implements ActionListener, MouseListener {
	...
	public static void main(String[] args) {
		DlgRetornoDefectos dialog = new DlgRetornoDefectos();
	...
	protected void actionPerformedBtnActualizar(ActionEvent e) {
		DlgRetornoDefectos dlgIngesoDefectos= new DlgRetornoDefectos();
	...
	public void reporte () {
		...
		txtS.setText("");
		imprimir(ai.obtener(indice).tallasCompletas());
	}
